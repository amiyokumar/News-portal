...
const Rusia = ({cat}) => {
  ...
  useEffect(()=>{
    axios.get("https://newsapi.org/v2/top-headlines?country=ru&apiKey=5eecd1feae2c4104a59359eeb7e5f191")
    .then((res)=>{
...
return (
  <>
    <h1 className="text-center" style={{color:'orange', margin: '10px 0px', marginTop: '30px' }}>Top Trending News of Rusia</h1>
