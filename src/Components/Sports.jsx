...
const Sports = ({cat}) => {
  ...
  useEffect(()=>{
    axios.get("https://newsapi.org/v2/everything?q=sports&apiKey=5eecd1feae2c4104a59359eeb7e5f191")
    .then((res)=>{
...
return (
  <>
  <h1 className="text-center" style={{color:'orange', margin: '10px 0px', marginTop: '30px' }}>Top Sports News</h1>
       <LoadingBar
        height={3}
        color='#f11946'
            ...
            return(
              ...
              <div className="card" style={{width : "18rem"}}>
                ...
                <div className="card-body">
                  <h5 className="card-title">{val.title.substring(0,100)}...</h5>
